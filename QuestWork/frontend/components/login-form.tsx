      ...
      <div className="mx-auto w-full max-w-md">
        <div className="rounded-2xl border border-border bg-background p-8 shadow-lg shadow-primary/5">
          ...
          <div className="space-y-3">
            <button
                type="button"
                onClick={() => (window.location.href = "http://localhost:8000/oauth2/authorization/kakao")}
            ...
            <button
                type="button"
                onClick={() => (window.location.href = "http://localhost:8000/oauth2/authorization/naver")}
        ...
        </div> {/* ✅ 이 div(카드 박스)가 닫히는 곳 */}

        <SignupModal open={isSignupOpen} onOpenChange={setIsSignupOpen} />
      </div> // ✅ 이 div(가장 바깥쪽)가 닫히는 곳
  );
}

// 아이콘 함수들 (LoginForm 바깥에 위치)
function KakaoIcon() {
  return (
