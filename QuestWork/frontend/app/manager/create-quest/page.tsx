      ...
      <div className="min-h-screen bg-[#F8F7FC]">
        ...
        <main className="px-4 py-6 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-384 space-y-6">
            ...
            <div className="overflow-hidden rounded-4xl border border-purple-100 bg-linear-to-br from-purple-50 via-white to-white px-6 py-7 shadow-[0_28px_70px_-48px_rgba(109,40,217,0.55)] sm:px-8">
            ...
            >
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={10}
                          className="mt-2 min-h-60 w-full resize-y rounded-2xl border border-purple-100 bg-purple-50/30 px-4 py-4 text-base leading-7 text-foreground placeholder:text-slate-400 transition-colors focus:border-primary focus:outline-none focus:ring-4 focus:ring-primary/10"
                          required
                        />
                      </div>
                    </div>
                ...
                <aside className="xl:sticky xl:top-24 xl:self-start">
                  <Card className="overflow-hidden rounded-4xl border border-purple-100 bg-white shadow-[0_28px_80px_-52px_rgba(109,40,217,0.65)]">
                    <div className="space-y-5 p-6">
                      <div className="rounded-3xl bg-linear-to-br from-primary to-[#8B5CF6] p-5 text-white">
        ...
        <DialogContent className="max-w-md rounded-[28px] border border-[#A78BFA]/25 bg-white p-0 shadow-[0_30px_80px_-36px_rgba(109,40,217,0.35)]">
          <div className="px-8 pb-8 pt-9">
            <DialogHeader className="items-center text-center">
              <div className="mb-5 flex h-18 w-18 items-center justify-center rounded-full bg-[#6D28D9]/8 ring-8 ring-[#A78BFA]/10">
                <CheckCircle2
              ...
              <DialogDescription className="max-w-65 pt-2 text-center text-sm leading-6 text-foreground-muted">
                등록한 퀘스트 페이지로 이동합니다.
              </DialogDescription>
            </DialogHeader>
