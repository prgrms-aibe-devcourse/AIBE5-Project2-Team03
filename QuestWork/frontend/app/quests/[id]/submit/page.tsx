      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-2xl px-4 py-16 text-center">
          ...
          <Card className="mx-auto mt-6 max-w-sm border border-border p-4 text-left text-sm">
            <p className="font-semibold text-foreground">{result.submissionTitle}</p>
            <div className="mt-2 space-y-1 text-foreground-muted">
              <p>제출 ID: #{result.submissionId}</p>
              <p>버전: v{result.versionNo}</p>
              <p>상태: {result.status === 'SUBMITTED' ? '제출됨' : result.status}</p>
              <p>제출일: {new Date(result.submittedAt).toLocaleString('ko-KR')}</p>
            </div>
          </Card>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* 제출 방식 */}
          <Card className="border border-border p-6">
            <h2 className="mb-4 text-base font-semibold text-foreground">제출 방식 선택</h2>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground-muted">공개 저장소 URL을 입력합니다.</p>
                </div>
              </label>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground-muted">Google Drive, Dropbox 등 공유 링크를 입력합니다.</p>
                </div>
              </label>
            </div>
